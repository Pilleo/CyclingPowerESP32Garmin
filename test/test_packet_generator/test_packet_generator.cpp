...
void test_packet_structure_compliance() {
    ...
    // Execute
    size_t len = BlePacketGenerator::generatePacket(power, crankRevs, crankTime, buffer);

    // Expected Output Analysis:
    // 1. Flags (2 bytes):
    //    CPM_FLAG_WHEEL_REV_DATA_PRESENT (0x10) | CPM_FLAG_CRANK_REV_DATA_PRESENT (0x20) = 0x30
    //    Little Endian: 0x30, 0x00
